                    ...
                    {step === 4 && (
                        <div className="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea value={form.detailKejadian} onChange={e => set('detailKejadian', e.target.value)} rows={5} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none" placeholder="Ceritakan kronologi..." />
                    ...
                    {step === 5 && (
                        <div className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                {form.harapan.includes('Lainnya') && <input value={form.harapanLain} onChange={e => set('harapanLain', e.target.value)} className="mt-2 w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium outline-none focus:ring-2 focus:ring-primary/20" placeholder="Sebutkan harapan Anda..." />}
                            </div>
                            <div className="flex gap-3 mt-6">
